...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionBreathingHighlight = QAction("关闭呼吸高亮", MainWindow)
        ...
        self.actionToggleLeftPanel = QAction("隐藏左侧面板", MainWindow)
        ...
        self.actionToggleRightPanel = QAction("隐藏右侧面板", MainWindow)
